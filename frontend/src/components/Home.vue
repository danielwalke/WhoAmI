<template>
  ...
  class="flex flex-col items-center justify-center lg:w-2/3 w-full bg-opacity-80  rounded-2xl lg:p-8 p-2"> 
      ...
      <h1 class="text-2xl lg:text-5xl font-bold mb-4 text-center">
      ...
      <div class="bg-white/70 font-semibold text-gray-800 rounded-lg shadow-xl p-4 lg:p-8 max-w-2xl w-full">
        ...
        <h2 class="text-xl lg:text-2xl font-semibold text-sky-700 mb-4">
          How to Play:
        </h2>
        <ol class="list-decimal list-inside space-y-2 mb-8 text-base lg:text-lg">
